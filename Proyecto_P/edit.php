...
<body>
    ...
    <div class="container">
        <div class="row card m-3 p-3 bg-dark text-white-50">
            <h1 class="page-header text-center">Editar Materia Prima</h1>
            <hr>
            <form method="POST">
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="fcaducidad" name="fcaducidad" value="<?php echo $row->fcaducidad; ?>">
                    </div>
                </div>
                <hr>
