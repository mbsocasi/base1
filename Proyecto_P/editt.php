    ...
    <div class="row">
        ...
        <form method="POST">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="fechacaducidad" name="fechacaducidad" value="<?php echo $row->fechacaducidad; ?>">
                </div>
            </div>
            <div class="mb-3 row">
                <label class="col-sm-2 col-form-label">Fecha Elaboracion</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="fechaelaboracion" name="fechaelaboracion" value="<?php echo $row->fechaelaboracion; ?>">
                </div>
            </div>
