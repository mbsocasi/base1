...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="https://www.pngall.com/wp-content/uploads/8/Restaurant-Logo-PNG-Free-Download.png" alt="Logo" width="30" height="24" class="d-inline-block align-text-top">
      Restaurante</a>
    ...
    <div class="collapse navbar-collapse" id="navbarColor02">
      ...
      <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#">Inventario Materia Prima</a>
        </li>
        <li class="nav-item">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            <a href="add.php" class="btn btn-primary addx">Añadir Producto</a>
